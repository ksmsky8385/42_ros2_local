...
void Turtlebot3Sensor::onMelody()
{
  ...
  if(melody_interrupted_){
    noTone(BDPIN_BUZZER);
    current_note_number = 0;
    pre_note_number = 7;
    melody_interrupted_ = false;
  }
...
void Turtlebot3Sensor::makeMelody(uint8_t index)
{
  ...
  const uint16_t NOTE_CS4 = 277;  // 도#
  const uint16_t NOTE_D4  = 294;
  const uint16_t NOTE_DS4 = 311;  // 레# (= 미b)
  const uint16_t NOTE_E4  = 330;
  const uint16_t NOTE_F4  = 349;
  const uint16_t NOTE_FS4 = 370;  // 파#
  const uint16_t NOTE_G4  = 392;
  const uint16_t NOTE_GS4 = 415;  // 솔#
  const uint16_t NOTE_A4  = 440;
  const uint16_t NOTE_AS4 = 466;  // 라# (= 시b)
  const uint16_t NOTE_B4  = 494;
  const uint16_t NOTE_C5  = 523;
  const uint16_t NOTE_CS5 = 554;  // 도#5
  const uint16_t NOTE_D5  = 587;
  const uint16_t NOTE_DS5 = 622;  // 레#5
  ...
  switch (index)
  {
    case ON:  // 스타워즈 메인 테마 (Eb장조)
      melody_note_[0] = NOTE_G4;   melody_duration_[0] = 4;
      melody_note_[1] = NOTE_G4;   melody_duration_[1] = 4;
      melody_note_[2] = NOTE_G4;   melody_duration_[2] = 4;
      melody_note_[3] = NOTE_DS4;  melody_duration_[3] = 3;
      melody_note_[4] = NOTE_AS4;  melody_duration_[4] = 8;
      melody_note_[5] = NOTE_G4;   melody_duration_[5] = 2;
      melody_note_[6] = NOTE_DS4;  melody_duration_[6] = 3;
      melody_note_[7] = NOTE_AS4;  melody_duration_[7] = 8;
     break;

    case OFF:  // 죠스 테마 (점점 빨라짐)
      melody_note_[0] = NOTE_E4;   melody_duration_[0] = 2;
      melody_note_[1] = NOTE_F4;   melody_duration_[1] = 2;
      melody_note_[2] = NOTE_E4;   melody_duration_[2] = 3;
      melody_note_[3] = NOTE_F4;   melody_duration_[3] = 3;
      melody_note_[4] = NOTE_E4;   melody_duration_[4] = 4;
      melody_note_[5] = NOTE_F4;   melody_duration_[5] = 4;
      melody_note_[6] = NOTE_E4;   melody_duration_[6] = 8;
      melody_note_[7] = NOTE_F4;   melody_duration_[7] = 8;
     break;
    ...
    case BUTTON1:
      melody_note_[0] = NOTE_C4;   melody_duration_[0] = 8;
      melody_note_[1] = NOTE_E4;   melody_duration_[1] = 8;
      melody_note_[2] = NOTE_G4;   melody_duration_[2] = 4;
      melody_note_[3] = 0;         melody_duration_[3] = 8;
      melody_note_[4] = 0;         melody_duration_[4] = 8;
      melody_note_[5] = 0;         melody_duration_[5] = 8;
      melody_note_[6] = 0;         melody_duration_[6] = 8;
      melody_note_[7] = 0;         melody_duration_[7] = 8;
    ...
    case 6:  // 도
      melody_note_[0] = NOTE_C4;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
      melody_note_[5] = 0;         melody_duration_[5] = 32;
      melody_note_[6] = 0;         melody_duration_[6] = 32;
      melody_note_[7] = 0;         melody_duration_[7] = 32;
     break;

    case 7:  // 레
      melody_note_[0] = NOTE_D4;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
    ...
    case 8:  // 미
      melody_note_[0] = NOTE_E4;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
    ...
    case 9:  // 파
      melody_note_[0] = NOTE_F4;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
    ...
    case 11:  // 라
      melody_note_[0] = NOTE_A4;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
    ...
    case 12:  // 시
      melody_note_[0] = NOTE_B4;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
    ...
    case 13:  // 도(높은)
      melody_note_[0] = NOTE_C5;   melody_duration_[0] = 8;
      melody_note_[1] = 0;         melody_duration_[1] = 32;
      melody_note_[2] = 0;         melody_duration_[2] = 32;
      melody_note_[3] = 0;         melody_duration_[3] = 32;
      melody_note_[4] = 0;         melody_duration_[4] = 32;
